...
require (
	...
	github.com/inspektor-gadget/inspektor-gadget v0.45.1-0.20251020222545-c91c23581ebf // indirect
...
// Pin runtime-spec to v1.2.1 to maintain compatibility with containerd v1.7.32.
